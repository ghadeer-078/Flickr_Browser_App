package com.example.flickr_browser_app.Resource
...
import com.example.flickr_browser_app.Model.Photo
import com.example.flickr_browser_app.Model.PhotoCollection
import com.example.flickr_browser_app.PhotoDetailsActivity
import com.example.flickr_browser_app.databinding.PhotoItemBinding


class Adapter(val context: Context, val photos: PhotoCollection) :
